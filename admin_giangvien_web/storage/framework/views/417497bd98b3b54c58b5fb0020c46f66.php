            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="background-color:#b3d9ff; padding:0;">
                    <div class="row row-cols-5 g-0 text-center">
                        ...
                        <!-- Tài khoản sinh viên -->
                        <a href="<?php echo e(route('adminhomes.taikhoansv')); ?>">
                                   <div class="col">
                        ...
                        <a href="<?php echo e(route('adminhomes.taikhoangv')); ?>">
                             <div class="col">
                            <div class="card h-100 shadow-sm rounded-0">
                                <div class="card-body">
                        ...
                        <a href="<?php echo e(route('adminhomes.monhoc_lophp')); ?>">
                        ...
                        <!-- Giám sát nhận diện -->
                        <a href="<?php echo e(route('adminhomes.giamsat_nhandien')); ?>">
                             <div class="col">
                            <div class="card h-100 shadow-sm rounded-0">
                                <div class="card-body">
                        ...
                        <!-- Dữ liệu điểm danh -->
                        <a href="<?php echo e(route('adminhomes.dulieudiemdanh')); ?>">
                             <div class="col">
                            <div class="card h-100 shadow-sm rounded-0">
                                <div class="card-body">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laravel\admin_giangvien\resources\views/admins/index.blade.php ENDPATH**/ ?>
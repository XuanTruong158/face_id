...
class UserAdapter : RecyclerView.Adapter<UserAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var imgstatusaccout: ImageView = itemView.findViewById(R.id.txtstatusaccout)
        ...
        var btnxoa: ImageView = itemView.findViewById(R.id.btnxoa)
        var btnsua: ImageView = itemView.findViewById(R.id.btnsua)
